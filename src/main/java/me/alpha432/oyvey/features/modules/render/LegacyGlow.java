...
public class LegacyGlow
    ...
    public LegacyGlow() {
        super("LegacyGlow", "ESP", Category.RENDER, false, false,false);
        this.setInstance();
    }
    ...
    public void onRenderModel(RenderEntityModelEvent renderEntityModelEvent) {
        ...
        Color color = this.colorSync.getValue() ? EntityUtil.getColor(renderEntityModelEvent.entity, ColorUtil.rainbow(ClickGui.getInstance().rainbowHue.getValue()).getRed(), ColorUtil.rainbow(ClickGui.getInstance().rainbowHue.getValue()).getGreen(), ColorUtil.rainbow(ClickGui.getInstance().rainbowHue.getValue()).getBlue(), this.alpha.getValue(), this.colorFriends.getValue()) : EntityUtil.getColor(renderEntityModelEvent.entity, this.red.getValue(), this.green.getValue(), this.blue.getValue(), this.alpha.getValue(), this.colorFriends.getValue());
